...
@pytest.fixture
def filled_data(yml_dataset: dict, group: ChatGroup, user_serialized_data: dict, user: User, message_text: str) -> dict:
    ...
    data["successed_response_for_another_user"]["data"]["chat_id"] = data["successed_response_for_user"]["data"]["chat_id"] = group.id
